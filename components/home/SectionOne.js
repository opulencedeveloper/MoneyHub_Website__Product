...
const SectionOne = () => {
  return (
    <div className="relative flex flex-col overflow-x-hidden pl-5 pt-36 top-0 z-0 bg-primary w-full h-max text-white space-y-10 md:pt-60 md:pl-10 lg:flex-row lg:h-screen lg:space-y-0 ">
